    ...
    return (
        <div className="flex flex-col items-center justify-center h-screen text-center p-4">
            <div className="max-w-sm w-full">
                ...
                <h1 className="text-4xl sm:text-6xl font-bold text-color_focus">
                    404 <span className='text-action'>ERROR</span>
                </h1>
                <p className="text-lg sm:text-xl text-color_extra mt-2">
